...
public  class Musik implements ServerCommand {
    ...
    public String help() {
		...
		public void perfomrCommand(Member m, TextChannel channel, Message message, MessageReceivedEvent e) {
	        ...
	        switch (args[1].toLowerCase()) {
	            ...
	            case "stop":
	            	MusicController controller2 = Main.INSTANCE.playerManager.getController(e.getGuild().getIdLong());
		      ...
		      /*  case "add":
		        	MusicController controller21 = Main.INSTANCE.playerManager.getController(e.getGuild().getIdLong());
	            	AudioPlayer player = controller21.getPlayer();
		        			
	            	controller21.getQueue().addTrackToQueue(track);
		        	break;
		      */
